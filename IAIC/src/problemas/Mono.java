...
public class Mono extends Problema{
	 ...
	 */
	public Mono(){
		enunciado = " Hay un mono en la puerta de una habitación. En el centro de\n"
				+ " la habitación hay un plátano colgando del techo. El mono está\n"
				+ " hambriento y quiere conseguir el plátano pero no alcanza\n"
				+ " porque está muy alto. En la habitación también hay una ventana\n"
				+ " y debajo de ella hay una caja que le permitiría alcanzar el\n "
				...
				+ " caja está justo debajo del plátano). Consigue que el mono coja\n"
				+ " el platano.";
